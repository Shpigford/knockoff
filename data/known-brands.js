...
// "Established" = real company with a track record, warranty, and reputation to
// lose.
...
var KO_KNOWN_BRANDS = [
  ...
  "Doxie", "Ducky", "Eaton", "Eaton", "Echo", "Ecobee", "Elgato", "Emerson",
  "Epson", "Ergodox", "EVGA", "Filco", "Fire TV", "First Alert", "Fitbit",
  "Fujitsu", "Garmin", "GE", "Gigabyte", "Google", "Honeywell", "HP", "HTC",
  "Hubbell", "Huion", "HyperX", "iFixit", "Insignia", "Intel", "JVC",
  "Kensington", "Keychron", "Kidde", "Kindle", "Kinesis", "Kingston", "Kioxia",
  "Legrand", "Lenovo", "Leopold", "Leviton", "LG", "Linksys", "Logitech",
  "Lutron", "Meta", "Microsoft", "Monoprice", "Mophie", "MSI", "Nanuk", "Nest",
  "Netgear", "Nintendo", "NuTone", "Nvidia", "Oculus", "Onn", "OtterBox",
  "Oura", "OWC", "Panasonic", "Panasonic WhisperFit", "Pelican", "Philips",
  "PlayStation", "Plustek", "PNY", "Polar", "QNAP", "Raspberry Pi", "Razer",
  "Realforce", "Ring", "Rocketbook", "Roku", "Samsung", "SanDisk", "Satechi",
  "Sceptre", "Seagate", "Sharp", "Siemens", "SKB", "Sony", "SparkFun", "Spigen",
